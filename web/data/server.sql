...
CREATE TABLE deployment (
    ...
    , camera INT NOT NULL REFERENCES camera(id)
    , deployer INT NOT NULL REFERENCES person(id)
...
CREATE TABLE deployment_picture (
      id SERIAL UNIQUE PRIMARY KEY NOT NULL
    , deployment_id INT NOT NULL REFERENCES deployment(id)
...
CREATE TABLE image (
    ...
    , burst_date INT NOT NULL REFERENCES burst(id)
    , file_name TEXT NOT NULL
    , file_type TEXT NOT NULL
    -- exif data follows
    , width INT NOT NULL
...
CREATE TABLE tag (
    ...
    , x INT NOT NULL 
    , y INT NOT NULL
    , tagger INT NOT NULL REFERENCES person(id)
);
